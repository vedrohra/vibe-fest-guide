...
import vaelsLogo from "@/assets/vaels-logo.jpeg.asset.json";
...
const events = [
  ...
  },
  {
    ...
    desc: "Three rounds of entrepreneurship — pitch your venture, survive a crisis, then negotiate a merger. Teams of 3 thinking on their feet.",
  ...
  },
  {
    ...
    desc: "Imagine it. Design it. Develop it. Teams are handed a product and must improve it, adapting live as judges throw in new obstacles.",
  ...
  },
  {
    ...
    slug: "trivia",
    name: "Trivia",
    desc: "A business quiz on markets, brands and founders. Teams of 2 take a written prelim, and the top 6 fight it out in a live final.",
    image: trivia.url,
